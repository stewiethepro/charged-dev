...
export const ProfileSettingsPageComponent = props => {
  ...
  const handleSubmit = values => {
    const { firstName, lastName, bio: rawBio, registration } = values;
  ...
  const { registration } = protectedData
  ...
  const profileSettingsForm = user.id ? (
    <ProfileSettingsForm
      ...
      initialValues={{ firstName, lastName, bio, registration, profileImage: user.profileImage }}
